...
// CollectMetrics provides a mock function with given fields: captureAddr, id
func (_m *MockDB) CollectMetrics(captureAddr string, id int) {
	_m.Called(captureAddr, id)
}
